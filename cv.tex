...
\address{hanyuny@andrew.cmu.edu, 341-3147855}
...
{\bf Carnegie Mellon University} \hfill{Silicon Valley, CA} \hfill{\em Feb. 2021 - Dec. 2022}
\begin{itemize} \item {M.S. in Software Engineering} \end{itemize}
...
\begin{rSection}{Work Experience}
    \begin{rSubsection}{Novatek, Inc}{Hsinchu, Taiwan}{Software Firmware Engineer}{Aug 2020 - June 2021}
        \item Integrated verification report feature for audio/DSP part of latest SmartTV SoC IC.
        \item Optimizied DTS audio algorithm using Tensilia Hifi2/Hifi4 DSP processor.
    \end{rSubsection}
...
\begin{rSection}{Activities}
    \begin{rSubsection}{2020 Formosa Grand Challenge}{Taipei, Taiwan}{Participant}{Nov. 2019 - Apr. 2020}
        ...
        \item Achieved 3\ts{rd} place and won \$10,000 prize.
    \end{rSubsection}
